# Academic Papers on Internet Governance and Digital Sovereignty

## Overview
This document compiles key academic papers on internet governance, cyber sovereignty, digital sovereignty, and platform governance. Papers are organized by topic with bibliographic information and abstracts where available.

---

## 1. Internet Governance

### 1.1 Multistakeholder Governance Model

#### Paper 1: Who Runs the Internet? The Global Political Economy of Internet Governance
- **Authors**: Jack Goldsmith & Tim Wu
- **Journal**: Stanford Law Review / Book: Who Controls the Internet? Illusions of a Borderless World
- **Year**: 2006
- **Publisher**: Oxford University Press
- **DOI/Link**: https://global.oup.com/academic/product/who-controls-the-internet-9780195340648
- **Abstract**: This influential work challenges the notion of a borderless, ungovernable internet, arguing that territorial governments exercise significant control over the internet through various means. The authors examine how different nations assert jurisdiction over internet activities within their borders.

#### Paper 2: The Working Definition of Internet Governance
- **Authors**: Working Group on Internet Governance (WGIG)
- **Publication**: WGIG Report
- **Year**: 2005
- **Link**: https://www.wgig.org/docs/WGIGREPORT.pdf
- **Abstract**: The WGIG defined internet governance as "the development and application by Governments, the private sector and civil society, in their respective roles, of shared principles, norms, rules, decision-making procedures, and programmes that shape the evolution and use of the Internet."

#### Paper 3: Governing Networks and Rule-Making in Cyberspace
...
#### Paper 6: The Limits of Leviathan: Contract Theory and the Enforcement of International Law
...
### 2.1 China's Cyber Sovereignty

#### Paper 9: Authoritarian Informationalism: China's Approach to Internet Sovereignty
- **Author**: Min Jiang
...
- **Authors**: Katharin Tai & Yuan Yi Zhu
...
### 2.2 Sovereignty and the Internet

#### Paper 13: The Impact of the Internet on Sovereignty: Unfounded and Real Worries
...
### 3.1 EU Digital Sovereignty

#### Paper 16: Digital Sovereignty
- **Authors**: Julia Pohle & Thorsten Thiel
...
- **Authors**: Lusine Vardanyan & Hovsep Kocharyan
...
#### Paper 20: Breaking the Web: Data Localization vs. the Global Internet
- **Authors**: Anupam Chander & Uyên P. Lê
- **Journal**: Emory Law Journal
- **Year**: 2015
- **Volume**: 64(3)
- **Pages**: 677-739
...
- **Authors**: Jonathan Obar & Andrew Clement
- **Publication**: SSRN
- **Year**: 2013
- **SSRN**: 2311792
...
#### Paper 24: Custodians of the Internet: Platforms, Content Moderation, and the Hidden Decisions That Shape Social Media
...
- **Publication**: Wired
- **Year**: 2014
- **Link**: https://www.wired.com/2014/10/content-moderation/
- **Abstract**: Investigative piece revealing the psychological toll on content moderators who view disturbing content, often outsourced to low-wage areas.

### 4.2 Algorithmic Governance

#### Paper 28: Algorithms of Oppression: How Search Engines Reinforce Racism
...
### 5.1 Global Internet Fragmentation

#### Paper 33: The Declaration of the Independence of Cyberspace
- **Author**: John Perry Barlow
- **Publication**: Electronic Frontier Foundation
- **Year**: 1996
- **Link**: https://www.eff.org/cyberspace-independence
- **Abstract**: Iconic declaration arguing that governments have no right to govern the internet, representing the early cyber libertarian perspective that states should stay out of cyberspace.
...
This bibliography was compiled through:
1. Systematic search of academic databases (MDPI, arXiv, Internet Policy Review)
2. Wikipedia reference mining for established scholarship
3. Citation tracking of seminal works in the field
4. Review of key journals: Internet Policy Review, Information & Communications Technology Law, SAIS Review

**Date Compiled**: January 2026

**Disclaimer**: Some abstracts are summaries based on available information. Researchers should verify full citations and access original sources for complete information.
